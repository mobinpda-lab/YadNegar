...
## 0. قانون PRODUCT FIRST — قانون حاکم پروژه

**کارخانه وسیله است؛ یادنگار محصول نهایی است.**

هر تصمیم، تغییر، توسعه، اصلاح، اتوماسیون، Workflow، CI یا Governance در کارخانه فقط زمانی مجاز و اولویت‌دار است که در خدمت **تولید، تکمیل، آزمایش و تحویل یادنگار** باشد.

### معیار موفقیت نهایی

**یادنگار قابل استفاده و Release-Ready است؛ نه کارخانه‌ای که صرفاً خودش سالم اجرا می‌شود.**

قواعد اجرایی:
- Product outcome بر سلامت صرفِ کارخانه اولویت دارد.
- Automation ابزار تسریع و حفاظت از Product است، نه هدف مستقل.
- هیچ Workflow، Orchestrator یا زیرساخت موازی صرفاً برای «سالم‌بودن کارخانه» ساخته نشود.
- وقتی بین بهبود کارخانه و پیشرفت قابل‌تحویل محصول تعارض ایجاد شد، تصمیم باید بر اساس اثر مستقیم و قابل‌اندازه‌گیری بر مسیر Release-Ready شدن یادنگار ثبت شود.
- در هر «ادامه»، تا حد امکان کار واقعی محصول، تست، Evidence، Android validation و Release readiness در GitHub جلو برده شود و گزارش جایگزین اجرا نشود.
