...
## پروتکل استاندارد توسعه و خودکارسازی

مرجع اجرایی چرخه‌های توسعه، خودکارسازی و بهینه‌سازی محصول در `docs/YADNEGAR_DEVELOPMENT_AUTOMATION_PROTOCOL_FA.md` ثبت شده است. این پروتکل **PRODUCT FIRST**، اجرای موازی کنترل‌شده، CI/CD موازی، تست محصول و صداقت در گزارش وضعیت را الزام می‌کند.
