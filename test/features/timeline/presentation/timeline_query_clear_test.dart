...
void main() {
  testWidgets('query can be cleared without clearing active date range',
      (tester) async {
    ...
    expect(find.byKey(const Key('timeline-item-inside-other')), findsOneWidget);
    ...
    expect(find.byKey(const Key('timeline-item-outside-match')), findsNothing);
    expect(find.byKey(const Key('timeline-query-clear')), findsOneWidget);

    await tester.tap(find.byKey(const Key('timeline-query-clear')));
    await tester.pumpAndSettle();
    ...
    expect(find.byKey(const Key('timeline-query-clear')), findsNothing);
    expect(
      tester
